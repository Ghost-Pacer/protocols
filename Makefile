...
run: ghostpacer/run/rundown1.proto run/runup1.proto run/track_start_point.proto
	cd ghostpacer/run; $(PROTOC) --python_out=$(DEST_DIR)/ --swift_out=$(DEST_DIR)/ $(SRC_DIR)/rundown1.proto; \
